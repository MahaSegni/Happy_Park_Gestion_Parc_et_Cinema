...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('RTC3zx+wcs', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('y5Bo3v1Bla', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('pu4T7QvMLV', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('JtQxVLotVd', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('UDGqQJFhtC', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('JGRaj+UMil', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('AT9R3NVDRl', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.bundles_metadata' => [
                ...
                'KnpSnappyBundle' => [
                    'path' => 'C:/xampp/htdocs/integration/integration/projet/projet/projet/vendor/knplabs/knp-snappy-bundle/src',
...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolder4e3c5 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializera9fd1 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicPropertiesec620 = [
        
    ];

    public function getConnection()
    {
        $this->initializera9fd1 && ($this->initializera9fd1->__invoke($valueHolder4e3c5, $this, 'getConnection', array(), $this->initializera9fd1) || 1) && $this->valueHolder4e3c5 = $valueHolder4e3c5;

        return $this->valueHolder4e3c5->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializera9fd1 && ($this->initializera9fd1->__invoke($valueHolder4e3c5, $this, 'getMetadataFactory', array(), $this->initializera9fd1) || 1) && $this->valueHolder4e3c5 = $valueHolder4e3c5;

        return $this->valueHolder4e3c5->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializera9fd1 && ($this->initializera9fd1->__invoke($valueHolder4e3c5, $this, 'getExpressionBuilder', array(), $this->initializera9fd1) || 1) && $this->valueHolder4e3c5 = $valueHolder4e3c5;

        return $this->valueHolder4e3c5->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializera9fd1 && ($this->initializera9fd1->__invoke($valueHolder4e3c5, $this, 'beginTransaction', array(), $this->initializera9fd1) || 1) && $this->valueHolder4e3c5 = $valueHolder4e3c5;

        return $this->valueHolder4e3c5->beginTransaction();
    }

    public function getCache()
    {
        $this->initializera9fd1 && ($this->initializera9fd1->__invoke($valueHolder4e3c5, $this, 'getCache', array(), $this->initializera9fd1) || 1) && $this->valueHolder4e3c5 = $valueHolder4e3c5;

        return $this->valueHolder4e3c5->getCache();
    }

    public function transactional($func)
    {
        $this->initializera9fd1 && ($this->initializera9fd1->__invoke($valueHolder4e3c5, $this, 'transactional', array('func' => $func), $this->initializera9fd1) || 1) && $this->valueHolder4e3c5 = $valueHolder4e3c5;

        return $this->valueHolder4e3c5->transactional($func);
    }

    public function commit()
    {
        $this->initializera9fd1 && ($this->initializera9fd1->__invoke($valueHolder4e3c5, $this, 'commit', array(), $this->initializera9fd1) || 1) && $this->valueHolder4e3c5 = $valueHolder4e3c5;

        return $this->valueHolder4e3c5->commit();
    }

    public function rollback()
    {
        $this->initializera9fd1 && ($this->initializera9fd1->__invoke($valueHolder4e3c5, $this, 'rollback', array(), $this->initializera9fd1) || 1) && $this->valueHolder4e3c5 = $valueHolder4e3c5;

        return $this->valueHolder4e3c5->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializera9fd1 && ($this->initializera9fd1->__invoke($valueHolder4e3c5, $this, 'getClassMetadata', array('className' => $className), $this->initializera9fd1) || 1) && $this->valueHolder4e3c5 = $valueHolder4e3c5;

        return $this->valueHolder4e3c5->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializera9fd1 && ($this->initializera9fd1->__invoke($valueHolder4e3c5, $this, 'createQuery', array('dql' => $dql), $this->initializera9fd1) || 1) && $this->valueHolder4e3c5 = $valueHolder4e3c5;

        return $this->valueHolder4e3c5->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializera9fd1 && ($this->initializera9fd1->__invoke($valueHolder4e3c5, $this, 'createNamedQuery', array('name' => $name), $this->initializera9fd1) || 1) && $this->valueHolder4e3c5 = $valueHolder4e3c5;

        return $this->valueHolder4e3c5->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializera9fd1 && ($this->initializera9fd1->__invoke($valueHolder4e3c5, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializera9fd1) || 1) && $this->valueHolder4e3c5 = $valueHolder4e3c5;

        return $this->valueHolder4e3c5->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializera9fd1 && ($this->initializera9fd1->__invoke($valueHolder4e3c5, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializera9fd1) || 1) && $this->valueHolder4e3c5 = $valueHolder4e3c5;

        return $this->valueHolder4e3c5->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializera9fd1 && ($this->initializera9fd1->__invoke($valueHolder4e3c5, $this, 'createQueryBuilder', array(), $this->initializera9fd1) || 1) && $this->valueHolder4e3c5 = $valueHolder4e3c5;

        return $this->valueHolder4e3c5->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializera9fd1 && ($this->initializera9fd1->__invoke($valueHolder4e3c5, $this, 'flush', array('entity' => $entity), $this->initializera9fd1) || 1) && $this->valueHolder4e3c5 = $valueHolder4e3c5;

        return $this->valueHolder4e3c5->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializera9fd1 && ($this->initializera9fd1->__invoke($valueHolder4e3c5, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializera9fd1) || 1) && $this->valueHolder4e3c5 = $valueHolder4e3c5;

        return $this->valueHolder4e3c5->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializera9fd1 && ($this->initializera9fd1->__invoke($valueHolder4e3c5, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializera9fd1) || 1) && $this->valueHolder4e3c5 = $valueHolder4e3c5;

        return $this->valueHolder4e3c5->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializera9fd1 && ($this->initializera9fd1->__invoke($valueHolder4e3c5, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializera9fd1) || 1) && $this->valueHolder4e3c5 = $valueHolder4e3c5;

        return $this->valueHolder4e3c5->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializera9fd1 && ($this->initializera9fd1->__invoke($valueHolder4e3c5, $this, 'clear', array('entityName' => $entityName), $this->initializera9fd1) || 1) && $this->valueHolder4e3c5 = $valueHolder4e3c5;

        return $this->valueHolder4e3c5->clear($entityName);
    }

    public function close()
    {
        $this->initializera9fd1 && ($this->initializera9fd1->__invoke($valueHolder4e3c5, $this, 'close', array(), $this->initializera9fd1) || 1) && $this->valueHolder4e3c5 = $valueHolder4e3c5;

        return $this->valueHolder4e3c5->close();
    }

    public function persist($entity)
    {
        $this->initializera9fd1 && ($this->initializera9fd1->__invoke($valueHolder4e3c5, $this, 'persist', array('entity' => $entity), $this->initializera9fd1) || 1) && $this->valueHolder4e3c5 = $valueHolder4e3c5;

        return $this->valueHolder4e3c5->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializera9fd1 && ($this->initializera9fd1->__invoke($valueHolder4e3c5, $this, 'remove', array('entity' => $entity), $this->initializera9fd1) || 1) && $this->valueHolder4e3c5 = $valueHolder4e3c5;

        return $this->valueHolder4e3c5->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializera9fd1 && ($this->initializera9fd1->__invoke($valueHolder4e3c5, $this, 'refresh', array('entity' => $entity), $this->initializera9fd1) || 1) && $this->valueHolder4e3c5 = $valueHolder4e3c5;

        return $this->valueHolder4e3c5->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializera9fd1 && ($this->initializera9fd1->__invoke($valueHolder4e3c5, $this, 'detach', array('entity' => $entity), $this->initializera9fd1) || 1) && $this->valueHolder4e3c5 = $valueHolder4e3c5;

        return $this->valueHolder4e3c5->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializera9fd1 && ($this->initializera9fd1->__invoke($valueHolder4e3c5, $this, 'merge', array('entity' => $entity), $this->initializera9fd1) || 1) && $this->valueHolder4e3c5 = $valueHolder4e3c5;

        return $this->valueHolder4e3c5->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializera9fd1 && ($this->initializera9fd1->__invoke($valueHolder4e3c5, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializera9fd1) || 1) && $this->valueHolder4e3c5 = $valueHolder4e3c5;

        return $this->valueHolder4e3c5->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializera9fd1 && ($this->initializera9fd1->__invoke($valueHolder4e3c5, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializera9fd1) || 1) && $this->valueHolder4e3c5 = $valueHolder4e3c5;

        return $this->valueHolder4e3c5->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializera9fd1 && ($this->initializera9fd1->__invoke($valueHolder4e3c5, $this, 'getRepository', array('entityName' => $entityName), $this->initializera9fd1) || 1) && $this->valueHolder4e3c5 = $valueHolder4e3c5;

        return $this->valueHolder4e3c5->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializera9fd1 && ($this->initializera9fd1->__invoke($valueHolder4e3c5, $this, 'contains', array('entity' => $entity), $this->initializera9fd1) || 1) && $this->valueHolder4e3c5 = $valueHolder4e3c5;

        return $this->valueHolder4e3c5->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializera9fd1 && ($this->initializera9fd1->__invoke($valueHolder4e3c5, $this, 'getEventManager', array(), $this->initializera9fd1) || 1) && $this->valueHolder4e3c5 = $valueHolder4e3c5;

        return $this->valueHolder4e3c5->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializera9fd1 && ($this->initializera9fd1->__invoke($valueHolder4e3c5, $this, 'getConfiguration', array(), $this->initializera9fd1) || 1) && $this->valueHolder4e3c5 = $valueHolder4e3c5;

        return $this->valueHolder4e3c5->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializera9fd1 && ($this->initializera9fd1->__invoke($valueHolder4e3c5, $this, 'isOpen', array(), $this->initializera9fd1) || 1) && $this->valueHolder4e3c5 = $valueHolder4e3c5;

        return $this->valueHolder4e3c5->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializera9fd1 && ($this->initializera9fd1->__invoke($valueHolder4e3c5, $this, 'getUnitOfWork', array(), $this->initializera9fd1) || 1) && $this->valueHolder4e3c5 = $valueHolder4e3c5;

        return $this->valueHolder4e3c5->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializera9fd1 && ($this->initializera9fd1->__invoke($valueHolder4e3c5, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializera9fd1) || 1) && $this->valueHolder4e3c5 = $valueHolder4e3c5;

        return $this->valueHolder4e3c5->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializera9fd1 && ($this->initializera9fd1->__invoke($valueHolder4e3c5, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializera9fd1) || 1) && $this->valueHolder4e3c5 = $valueHolder4e3c5;

        return $this->valueHolder4e3c5->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializera9fd1 && ($this->initializera9fd1->__invoke($valueHolder4e3c5, $this, 'getProxyFactory', array(), $this->initializera9fd1) || 1) && $this->valueHolder4e3c5 = $valueHolder4e3c5;

        return $this->valueHolder4e3c5->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializera9fd1 && ($this->initializera9fd1->__invoke($valueHolder4e3c5, $this, 'initializeObject', array('obj' => $obj), $this->initializera9fd1) || 1) && $this->valueHolder4e3c5 = $valueHolder4e3c5;

        return $this->valueHolder4e3c5->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializera9fd1 && ($this->initializera9fd1->__invoke($valueHolder4e3c5, $this, 'getFilters', array(), $this->initializera9fd1) || 1) && $this->valueHolder4e3c5 = $valueHolder4e3c5;

        return $this->valueHolder4e3c5->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializera9fd1 && ($this->initializera9fd1->__invoke($valueHolder4e3c5, $this, 'isFiltersStateClean', array(), $this->initializera9fd1) || 1) && $this->valueHolder4e3c5 = $valueHolder4e3c5;

        return $this->valueHolder4e3c5->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializera9fd1 && ($this->initializera9fd1->__invoke($valueHolder4e3c5, $this, 'hasFilters', array(), $this->initializera9fd1) || 1) && $this->valueHolder4e3c5 = $valueHolder4e3c5;

        return $this->valueHolder4e3c5->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializera9fd1 = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolder4e3c5) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolder4e3c5 = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolder4e3c5->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializera9fd1 && ($this->initializera9fd1->__invoke($valueHolder4e3c5, $this, '__get', ['name' => $name], $this->initializera9fd1) || 1) && $this->valueHolder4e3c5 = $valueHolder4e3c5;

        if (isset(self::$publicPropertiesec620[$name])) {
            return $this->valueHolder4e3c5->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder4e3c5;
    ...
    {
        $this->initializera9fd1 && ($this->initializera9fd1->__invoke($valueHolder4e3c5, $this, '__set', array('name' => $name, 'value' => $value), $this->initializera9fd1) || 1) && $this->valueHolder4e3c5 = $valueHolder4e3c5;
    ...
    {
        $this->initializera9fd1 && ($this->initializera9fd1->__invoke($valueHolder4e3c5, $this, '__isset', array('name' => $name), $this->initializera9fd1) || 1) && $this->valueHolder4e3c5 = $valueHolder4e3c5;
    ...
    {
        $this->initializera9fd1 && ($this->initializera9fd1->__invoke($valueHolder4e3c5, $this, '__unset', array('name' => $name), $this->initializera9fd1) || 1) && $this->valueHolder4e3c5 = $valueHolder4e3c5;
    ...
    {
        $this->initializera9fd1 && ($this->initializera9fd1->__invoke($valueHolder4e3c5, $this, '__clone', array(), $this->initializera9fd1) || 1) && $this->valueHolder4e3c5 = $valueHolder4e3c5;

        $this->valueHolder4e3c5 = clone $this->valueHolder4e3c5;
    }

    public function __sleep()
    {
        $this->initializera9fd1 && ($this->initializera9fd1->__invoke($valueHolder4e3c5, $this, '__sleep', array(), $this->initializera9fd1) || 1) && $this->valueHolder4e3c5 = $valueHolder4e3c5;

        return array('valueHolder4e3c5');
    }
    ...
    {
        $this->initializera9fd1 = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializera9fd1;
    }

    public function initializeProxy() : bool
    {
        return $this->initializera9fd1 && ($this->initializera9fd1->__invoke($valueHolder4e3c5, $this, 'initializeProxy', array(), $this->initializera9fd1) || 1) && $this->valueHolder4e3c5 = $valueHolder4e3c5;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolder4e3c5;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder4e3c5;
    }
...
class Paginator_f262b94 extends \Knp\Component\Pager\Paginator implements \ProxyManager\Proxy\VirtualProxyInterface
{
    ...
    {
        $this->initializera9fd1 && ($this->initializera9fd1->__invoke($valueHolder4e3c5, $this, 'setDefaultPaginatorOptions', array('options' => $options), $this->initializera9fd1) || 1) && $this->valueHolder4e3c5 = $valueHolder4e3c5;

        $this->valueHolder4e3c5->setDefaultPaginatorOptions($options);
return;
    }

    public function paginate($target, int $page = 1, ?int $limit = null, array $options = []) : \Knp\Component\Pager\Pagination\PaginationInterface
    {
        $this->initializera9fd1 && ($this->initializera9fd1->__invoke($valueHolder4e3c5, $this, 'paginate', array('target' => $target, 'page' => $page, 'limit' => $limit, 'options' => $options), $this->initializera9fd1) || 1) && $this->valueHolder4e3c5 = $valueHolder4e3c5;

        return $this->valueHolder4e3c5->paginate($target, $page, $limit, $options);
    }

    public function subscribe(\Symfony\Component\EventDispatcher\EventSubscriberInterface $subscriber) : void
    {
        $this->initializera9fd1 && ($this->initializera9fd1->__invoke($valueHolder4e3c5, $this, 'subscribe', array('subscriber' => $subscriber), $this->initializera9fd1) || 1) && $this->valueHolder4e3c5 = $valueHolder4e3c5;

        $this->valueHolder4e3c5->subscribe($subscriber);
return;
    }

    public function connect(string $eventName, $listener, int $priority = 0) : void
    {
        $this->initializera9fd1 && ($this->initializera9fd1->__invoke($valueHolder4e3c5, $this, 'connect', array('eventName' => $eventName, 'listener' => $listener, 'priority' => $priority), $this->initializera9fd1) || 1) && $this->valueHolder4e3c5 = $valueHolder4e3c5;

        $this->valueHolder4e3c5->connect($eventName, $listener, $priority);
return;
    }
    ...
    public function __construct(?\Symfony\Component\EventDispatcher\EventDispatcherInterface $eventDispatcher = null, ?\Symfony\Component\HttpFoundation\RequestStack $requestStack = null)
    {
        ...
        $this->valueHolder4e3c5->__construct($eventDispatcher, $requestStack);
    }
